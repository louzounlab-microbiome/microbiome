...
if __name__ == "__main__":
    ...
    david_dataset = DavidDataLoader(data, bactria_as_feature_file, samples_data_file, tax,
             create_regression_data, create_time_serie_data)
    david_dataset.run(run_regression, run_rnn, run_lstm, cross_validation=10, test_size=0.5)
