function [Theta_samples_lasso,Theta_samples_select,med_counts,med_biomass] = benchmarkDietDataBayes(cfg,T,perturbations,data,species_names,BMD,experimentBlocks,keep_species,intervene_matrix_filtered,intervene_matrix_filtered_merge,data_counts_filtered)
