function [] = doBayesianInference(cfg,outputDir,T,intervene_matrix,perturbations,data,species_names,BMD,experimentBlocks)
...
outputFileName = [outputDir 'bayes_inference.mat'];
