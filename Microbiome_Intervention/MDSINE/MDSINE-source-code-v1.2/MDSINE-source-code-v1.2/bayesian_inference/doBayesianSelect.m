function [] = doBayesianSelect(cfg,outputDir,T,intervene_matrix,perturbations,data,species_names,BMD,experimentBlocks)
...
outputFileName = [outputDir 'BVS.mat'];
...
Theta_global = Theta_select;
Theta_samples_global = Theta_samples_select;
