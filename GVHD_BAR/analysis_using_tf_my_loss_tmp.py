...
def my_loss(y_true, y_pred):
    ...
    return y_true[:, 4] * tsls + 5 * y_true[:, 3] * mse_loss
...
if PLOT_INPUT_TO_NN_STATS:
    ...
    plt.title(f'After outlier removal - STD={std}, MED={med}, Mean={mean}')# remove outliers
    plt.show()
    ...
    for dropput in dropout_list:
        for lr in lr_list:
            for epochs in epochs_list:
                ...
                if RECORD:
                    GRID_SEARCH_DIRECTORY = 'GridSearch_my_loss'
