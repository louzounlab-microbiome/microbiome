...
from infra_functions.time_series_analsys import compute_time_for_censored_using_similarity_matrix, time_series_analysis_tf, time_series_using_xgboost
import pandas as pd
import math
...
train_res, test_res  = time_series_using_xgboost(X, y,
                                                 ...
                                                 record=RECORD,
                                                 grid_search_dir='grid_search_xgboost_with_censored')
