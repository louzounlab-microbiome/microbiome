...
class AbstractDataLoader:
    def __init__(self, title, bactria_as_feature_file, samples_data_file, taxnomy_level, allow_printing,
        ...
        self._read_file(title, bactria_as_feature_file, samples_data_file, allow_printing,
    ...
    def get_X_y_for_nni(self, task):
        ids, tag_map, task_name = self.get_learning_data(task)
