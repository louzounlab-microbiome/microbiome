...
patients_dataset = patient_dataset.no_mapping(otumf.otu_features_df, metabolomics_table,
                                              transform=transforms.Compose([ToTensor()]))

with open(Path('../data/data_used/patients_datasets/patient_dataset'), 'wb') as patient_file:
    pickle.dump(patients_dataset, patient_file)
