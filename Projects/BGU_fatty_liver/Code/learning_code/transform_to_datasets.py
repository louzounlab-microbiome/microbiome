...
otu_features.to_csv(Path('../../data/exported_data/data_for_learning/otu_dataset.csv'))
otu_tag.to_csv(Path('../../data/exported_data/data_for_learning/otu_tag.csv'))
...
metabolomics_features.to_csv(Path('../../data/exported_data/data_for_learning/metabolomics_dataset.csv'))
metabolomics_tag.to_csv(Path('../../data/exported_data/data_for_learning/metabolomics_tag.csv'))
